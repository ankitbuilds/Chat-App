            ...
            <div className="w-full p-6 rounded-lg shadow-lg bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col">
                <div className="flex flex-col items-center justify-center">
                  ...
                  <input onChange={handleInput} id="femail" className="bg-white text-gray-600 input input-bordered h-10" type="email" placeholder="Enter Email" required ></input>
                  ...
                  <input onChange={handleInput} id="confpassword" className="bg-white text-gray-600 input input-bordered h-10" type="text" placeholder="Confirm Password" required ></input>
                </div>
